...
class Invitation(TimeStampedModel):
    ...
    sent_to = models.ForeignKey(User, on_delete=models.CASCADE, related_name='received_invitations',
                                verbose_name=_('Sent To'))
    status = models.CharField(max_length=5, choices=Status.choices, default=Status.PENDING, blank=True,
