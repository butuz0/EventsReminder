...
class UserManager(BaseUserManager):
    def _create_user(self, first_name: str, last_name: str, email: str, password: str | None, is_admin: bool = False, **extra_fields):  
        if not first_name:
    ...
    def create_superuser(self, first_name: str, last_name: str, email: str, password: str | None = None, **extra_fields):
