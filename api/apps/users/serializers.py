...
class CustomUserSerializer(UserSerializer):
    ...
    telegram_username = serializers.ReadOnlyField(source='profile.telegram_username')
    telegram_phone_number = PhoneNumberField(source='profile.telegram_phone_number')
